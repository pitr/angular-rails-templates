...
module AngularRailsTemplates
  class Template < ::Tilt::Template
    ...
    def prepare
      # we only want to process html assets inside Rails.root/app/assets and other folders specified in configuration
      @asset_inside_rails_root = configuration.inside_paths.any? { |folder| file.match folder.to_s }
